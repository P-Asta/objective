...
|[11. 제쟤체계](https://github.com/5-23/objective/blob/main/terms.md#11-제쟤체계)|
...
ex) 부모욕
## 도배 금지
> 정당한 사유없이 특정 메세지나 파일을 분당 3회 이상 보내는 행위

# 9. 선동, 선전 등의 금지
① 선전을 목적으로 문맥상 무관한 문자나 파일을 게시하여서는 아니된다.<br/>
② 선동을 목적으로 특정인이나 특정 사상을 비방하여서는 아니된다.<br/>
③ 선전 또는 선동을 목적으로하거나 문맥상 무관한 특정 문자나 파일, 이모지 등을 분 당 3회 이상 게시하여서는 아니된다.
